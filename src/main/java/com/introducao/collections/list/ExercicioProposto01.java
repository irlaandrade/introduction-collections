package com.introducao.collections.list;
...
public class ExercicioProposto01 {
    public static void main(String[] args) {
        ...
        temperaturasSemestral.forEach(t -> System.out.print(t + " "));

        //calculando e exibindo a média das temperaturas:
        double media = temperaturasSemestral.stream()
        ...
        Iterator<Double> iterator = temperaturasSemestral.iterator();
